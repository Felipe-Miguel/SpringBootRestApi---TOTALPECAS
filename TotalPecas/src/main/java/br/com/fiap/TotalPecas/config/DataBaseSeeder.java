...
public void run(String... args) throws Exception {
    Usuario u1 = new Usuario(1L, "Usuario1", "199999999", "19999999999", "19999999", "Rua1", "usuario1@gmail.com", 1, true);
    Usuario u2 = new Usuario(2L, "Usuario2", "299999999", "29999999999", "29999999", "Rua2", "usuario2@gmail.com", 2, true);
    Usuario u3 = new Usuario(3L, "Usuario3", "399999999", "39999999999", "39999999", "Rua3", "usuario3@gmail.com", 3, true);
    ...
    produtoRepository.saveAll(List.of(
        new Produto(1L, new BigDecimal(199.99), "Produto 1", listaAnos1, u1),
        new Produto(2L, new BigDecimal(150.49), "Produto 2", listaAnos1, u2),
        new Produto(3L, new BigDecimal(180.49), "Produto 3", listaAnos1, u3)
    ));
}
}
