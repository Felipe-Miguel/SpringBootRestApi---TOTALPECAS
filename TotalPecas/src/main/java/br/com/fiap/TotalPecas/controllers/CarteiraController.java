...
public class CarteiraController {
    ...
    return assembler.toModel(carteiras.map(Carteira::toEntityModel));
    }
    ...
    public ResponseEntity<Object> create(@RequestBody @Valid Carteira carteira, BindingResult result){
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body(carteira.toEntityModel());
    }
